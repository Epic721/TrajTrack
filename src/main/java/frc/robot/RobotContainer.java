...
// THE BELOW CODE IS INITIALIZATION FOR THE RAMSETE CONTROLLER AND IS REQUIRED 
    RamseteCommand ramseteCommand =
        new RamseteCommand(
            trajectory, //NEED TO OVERWRITE THIS WITH PATHWEAVER TRAJECTORY->DONE
            m_robotDrive::getPose,
            new RamseteController(AutoConstants.kRamseteB, AutoConstants.kRamseteZeta),
            new SimpleMotorFeedforward(
                DriveConstants.ksVolts, //THESE NEED TO BE DETERMINED THROUGH PHYSICAL ROBOT CHARACTERIZATION
                DriveConstants.kvVoltSecondsPerMeter,
                DriveConstants.kaVoltSecondsSquaredPerMeter),
            DriveConstants.kDriveKinematics,
